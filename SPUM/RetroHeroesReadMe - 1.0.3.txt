----------------------------------------------
     SPUM : Soonsoon Pixel Unit Maker
	   2D Retro Heroes - SPUM Premium Addon
     Copyright © 2021 Soonsoon
----------------------------------------------

Thanks for buying SPUM Premium Addon - 2D Retro Heroes for your game project!!

PLEASE NOTE that SPUM Premium Addon - 2D Retro Heroes can only be legally downloaded from the following 1 sources:

  1. Unity Asset Store (Standard License)

If you've obtained SPUM Premium Addon - 2D Retro Heroes via some other means then note that your license is effectively invalid,
...
2. You can using Sprites in Assets/SPUM/SPUM_Sprites/Packages/RetroHeroes
...
4. This add-on works with SPUM version 1.31 or higher.
